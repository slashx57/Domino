...
namespace DominoX10.Drivers
{
    ...
    /// CM15 driver.
    /// </summary>
    public class CM15 : X10Interface, IDisposable
    {
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="DominoX10.Drivers.CM15"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="DominoX10.Drivers.CM15"/>. The
        /// <see cref="Dispose"/> method leaves the <see cref="DominoX10.Drivers.CM15"/> in an unusable state. After
        /// calling <see cref="Dispose"/>, you must release all references to the <see cref="DominoX10.Drivers.CM15"/> so
        /// the garbage collector can reclaim the memory that the <see cref="DominoX10.Drivers.CM15"/> was occupying.</remarks>
        public void Dispose()
        {
