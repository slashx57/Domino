...
namespace DominoX10
{
    ...
    public static class Utility
    {
        ...
        private const int X10_MAX_LEVEL = 25;
        ...
        /// <param name="percentage"></param>
        /// <returns></returns>
        public static byte GetLevelValue(int percentage)
        {
            if (percentage > 100)
                percentage = 100;
            else if (percentage < 0)
                percentage = 0;
            byte levelvalue = (byte)Math.Floor(((double)percentage / 100D) * X10_MAX_LEVEL);
            return levelvalue;
        }
        ...
        /// <returns></returns>
        public static double GetLevelPercentage(byte dimvalue)
        {
            return Math.Round(((double)(dimvalue) / (double)X10_MAX_LEVEL), 2);
        }
